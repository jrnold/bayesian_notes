...
Preprocess the data into a centered and scaled design matrix, `X`, and a scaled response, `y`:
```{r}
rec <- recipe(xenovote ~ slavicshare + changenonslav + inc9903 + eduhi02 + unemp02 + apt9200,
                   vsall03 + brdcont, data = alexseev) %>%
