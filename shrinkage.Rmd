...
- Normal
- Student-t (default df = 1)
- Cauchy

Default scale values:

- Intercept: 10 (probit link - 16)
- Others: 2.5 (probit link - 4)
...
Similar to a spike an slab prior. 

- degrees of freeedom (>= 2) is the number of variates multiplied by
- standard deviation of normal variates multiplied
