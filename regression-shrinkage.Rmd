...
@PiironenVehtari2016a show that for a given $n$ (data standard deviation), $\tau$, $\lambda_k$, and $\sigma$, the and variance of $m_{eff}$ 
$$
\begin{aligned}[t]
...
@PiironenVehtari2016 provide no guidence on how to select $p_0$.
