...
### Choice of prior on Global Shrinkage

The performance of the sparse shrinkage estimators can depend quite heavily on the choice of $\tau$. 
In particular, there is usually not much information about sparsity of coefficients, and much data is required to estimate it. 

$$
\tau_0 = \frac{p_0}{K - p_0} \times \frac{\sigma}{\sqrt{n}}
$$
...
The prior distribution of the $k$-th element is
$$
\theta_k = \rho_k \sigma_y \sqrt{N - 1},
$$
where $\rho_k$ is the correlation between the $k$th column of $Q$ and the outcome.
