...
1.  Suppose you think its reasonable that no one can do worse than chance. So you restrict the support of $\theta$ to $\frac{1}{5}$. Estimate the model using a grid of theta values.
