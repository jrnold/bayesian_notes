...
#> history_size = 5
#> seed = 892274280
#> initial log joint probability = -136505
#> Exception thrown at line 29: normal_log: Scale parameter is 0, but must be > 0!
...
mod1_fit_opt
#> $par
#>         a      b[1]      b[2]      b[3]      b[4]      b[5]     sigma 
#>    -0.835    -0.587    15.238   -15.876     0.601     0.357     9.182 
#>     mu[1]     mu[2]     mu[3]     mu[4]     mu[5]     mu[6]     mu[7] 
#>    83.239    85.680    93.199    80.460    84.442    57.873    86.943 
#>     mu[8]     mu[9]    mu[10]    mu[11]    mu[12]    mu[13]    mu[14] 
#>    99.064    55.489    89.252    66.927    95.944    95.587    69.898 
#>    mu[15]    mu[16]    mu[17]    mu[18]    mu[19]    mu[20]    mu[21] 
#>    76.608    41.966    63.181    71.320    56.210    91.431    27.282 
#>    mu[22]    mu[23]    mu[24]    mu[25]    mu[26]    mu[27]    mu[28] 
#>    32.633    42.557    19.422    20.256    41.605    58.118    32.490 
#>    mu[29]    mu[30]    mu[31]    mu[32]    mu[33]    mu[34]    mu[35] 
#>    20.500    34.800    18.792     6.123    33.954    11.612    17.398 
#>    mu[36]    mu[37]    mu[38]    mu[39]    mu[40]    mu[41]    mu[42] 
#>    19.184    18.322    19.036    10.897    15.690    17.345    18.566 
#>    mu[43]    mu[44]    mu[45]  y_rep[1]  y_rep[2]  y_rep[3]  y_rep[4] 
#>    10.767    36.646    15.655    94.823    81.921   102.476    82.963 
#>  y_rep[5]  y_rep[6]  y_rep[7]  y_rep[8]  y_rep[9] y_rep[10] y_rep[11] 
#>    68.413    56.049    73.098    82.284    61.342    88.846    77.741 
#> y_rep[12] y_rep[13] y_rep[14] y_rep[15] y_rep[16] y_rep[17] y_rep[18] 
#>   112.570    89.772    79.830    91.879    56.198    66.533    69.826 
#> y_rep[19] y_rep[20] y_rep[21] y_rep[22] y_rep[23] y_rep[24] y_rep[25] 
#>    34.363    85.154    41.199    33.688    41.212    18.859    26.714 
#> y_rep[26] y_rep[27] y_rep[28] y_rep[29] y_rep[30] y_rep[31] y_rep[32] 
#>    36.700    53.421    23.216    18.489    36.709    43.055    10.210 
#> y_rep[33] y_rep[34] y_rep[35] y_rep[36] y_rep[37] y_rep[38] y_rep[39] 
#>    41.795    25.804    13.774    22.794    25.188    17.658     4.034 
#> y_rep[40] y_rep[41] y_rep[42] y_rep[43] y_rep[44] y_rep[45] 
#>    22.320    38.572     5.280    17.263    32.328    11.374 
#> 
#> $value
#> [1] -122
```
...
#> history_size = 5
#> seed = 940369814
#> initial log joint probability = -73081.3
#> Optimization terminated normally: 
#>   Convergence detected: relative gradient magnitude is below tolerance
```
