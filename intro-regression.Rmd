...
The function `r rdoc("stats", "model.matrix")` is the workhorse function used in `lm` and many other R functions to convert a formula into the matrix used in estimation.
```{r}
